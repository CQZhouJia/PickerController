//
//  SDImagePickControllerDelegate.m
//  PickerController
//
...
-(instancetype)initWithMaxImagesCount:(NSInteger)maxImagesCount columnNumber:(NSInteger)columnNumber delegate:(id<SDImagePickerControllerDelegate>)delegate{
    if (self = [super init]) {
        ...
        NSLog(@"---%zd----%zd",_maxImagesCount,maxImagesCount);
...
-(void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if ([self hiddenCamera:indexPath] && [self.pickerDelegate respondsToSelector:@selector(imagePickController:selectedCamera:)]) {
        [self.pickerDelegate imagePickerController:self selectedCamera:nil];
        return;
    }
...
-(UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    if ([self hiddenCamera:indexPath]) {
        ...
        cell.cameraView.image = [UIImage imageNamed:@"128-1"];
        return cell;
    }
    ...
    cell.maxImageCount= _maxImagesCount;
    SDAssetModel *model;
