...
-(void)getCameraRollVideo:(BOOL)pickingVideo PickingImage:(BOOL)PickingImage completion:(void (^)(SDAlbumModel *))completion{
...
-(void)getAllAlbums:(BOOL)pickingVideo PickingImage:(BOOL)PickingImage completion:(void (^)(NSArray<SDAlbumModel *> *))completion{
...
-(void)getPostImageWithAlbumModel:(SDAlbumModel *)model completion:(void (^)(UIImage *))completion{
    if (SDiOS8) {
